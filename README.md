...
> [!IMPORTANT] > **METHODO**: `POST`  
> **RUTA**:`/firebase/upload`  
> **DESCRIPCCION**: Se envia un formato de imagen y devuelve el nombre de la imagen uqe se guardo en la nuve.  
> **AUTORIZACION**: Si  
> **BODY**: Se envia el objeto formData

```javascript
> const formData = new FormData();
> formData.append("image", file); // 'image' debe coincidir con el nombre en el backend
```
...
```json
> { "imageProfile":"nombreImagen" ,"firstName": "user", "lastName": "1","idUniversidad": "0000300562","userName":"user1","email": "user1@unisabana.edu.co","phone":"1234567890","password": "user1"}
```
...
{
  "capacity": "4",
  "licensePhoto": "nueva_url_de_la_foto_de_licencia",
  "vehiclePhoto": "nueva_url_de_la_foto_del_vehículo",
  "soatPhoto": "nueva_url_de_la_foto_de_soat"
}
```
...
> [!IMPORTANT] > **METHODO**: `**RUTA**:` > **DESCRIPCCION**:
> **AUTORIZACION**:
> **BODY**:
